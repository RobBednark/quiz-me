...
from .models import Answer, Attempt, Tag, Question, QuestionTag, Schedule, ParentTag2ChildTag
...
class ParentTag2ChildTagAdmin(admin.ModelAdmin):
    ...
    def child_name(self, obj):
        # obj is a ParentTag2ChildTag object
...
admin.site.register(ParentTag2ChildTag, ParentTag2ChildTagAdmin)
