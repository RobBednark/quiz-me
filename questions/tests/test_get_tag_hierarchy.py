...
from questions.models import Question, Tag, ParentTag2ChildTag
...
class TestGetTagHierarchy:
    ...
    def setup_tags(self, user):
        ...
        ParentTag2ChildTag.objects.create(parent_tag=parent, child_tag=child1, user=user)
        ParentTag2ChildTag.objects.create(parent_tag=parent, child_tag=child2, user=user)
        ParentTag2ChildTag.objects.create(parent_tag=child1, child_tag=grandchild, user=user)
